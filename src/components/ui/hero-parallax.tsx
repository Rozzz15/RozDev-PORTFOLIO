...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className={`h-full overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d] bg-[#171614]/70 ${className}`}
    >
      <motion.div
        style={{
          rotateX,
      ...
      >
        ...
        <motion.div className="flex flex-row mb-8 space-x-8 sm:mb-20 sm:space-x-20">
...
export const ProductCard = ({
  ...
  return (
    <motion.div
      ...
      key={product.title}
      className="group/product h-48 w-[18rem] sm:h-72 sm:w-[24rem] md:h-96 md:w-[30rem] relative flex-shrink-0"
    >
      <a
        href={product.link}
